...
// https://vulkan-tutorial.com/code/26_texture_mapping.cpp
...
private:
    ...
    {
        std::vector<char> vertShaderCode = readFile("shaders/vert_26.spv");
        std::vector<char> fragShaderCode = readFile("shaders/frag_26.spv");
